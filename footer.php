			...
			<div class="row w-100 g-0 footer-informations">
				<div class="col-md-4 col-lg-3 offset-md-1">
					<div class="footer-box">
						...
						<a href="<?php the_field('whatsapp_link', 'options'); ?>" target="_blank" class="footer-box_whatsapp">
							...
							<?php the_field('whatsapp', 'options'); ?></a>
						<a href="mailto:<?php the_field('email', 'options'); ?></a>" class="footer-box_mail">
							...
							<?php the_field('email', 'options'); ?></a></a>
					</div>
				</div>
